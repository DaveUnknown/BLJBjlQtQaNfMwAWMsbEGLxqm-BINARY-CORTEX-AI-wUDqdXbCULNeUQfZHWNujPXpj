...
{   
    ...
    // Schedule the next random splat with a new random interval
    timer = setTimeout(randomSplat, Math.random() * 1000 * 5);
}

// Start the first random splat timer
setTimeout(function() { 
    timer = setTimeout(randomSplat, Math.random() * 1000 * 5);
...
let _bgImagePath = "";
function updatePropertyListener(name, val)
{
	switch(name) {
    case "quality":
    	switch(val){
